...
public class GPACalculatorActivity extends FragmentActivity implements
	...
	private static int GRADE_POSITION;
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.gpacalculator, menu);
		return true;
	}
	...
	public boolean onNavigationItemSelected(int position, long id) {
		...
		String [] actions = {"4.0 Scale", "9.0 Scale"};
		
		if (actions[position] == "4.0 Scale") {
			// Create new fragment and transaction
		    newFragment = new FourPointFragment();
		    Bundle args = new Bundle();
			args.putInt(FourPointFragment.ARG_SECTION_NUMBER, position + 1);
